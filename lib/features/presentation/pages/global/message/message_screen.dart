...
import 'package:trekr/core/constants/app_colors.dart';
import 'package:trekr/core/utils/helpers/helper_functions.dart';
import 'package:trekr/dependencies_injection.dart';
          ...
          children: [
            Padding(
              padding: EdgeInsets.only(
                  top: HelperFunctions.screenHeight(context) * .18.h),
              child: BlocProvider(
                create: (context) =>
                    locator<GetMessagesCubit>()..fetchMessages(),
                child: BlocBuilder<GetMessagesCubit, GetMessagesState>(
                  builder: (context, state) {
                    List<MessageEntity> allMessages = List.from(messageList);
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (message.messageType == MessageType.system) {
                            ...
                            final isCurrentUser =
                                message.sender!.id == widget.loggedInUserId;
